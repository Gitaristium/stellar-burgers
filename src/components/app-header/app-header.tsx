            ...
            {isMobile && (
              <>
                <li>
                  <span
                    className={`${
                      matchProfile ? styles.active : "text_color_inactive"
                    } ${
                      styles.link
                  ...
                  >
                    <ProfileIcon
                      type={matchProfile ? "primary" : "secondary"}
                    />
                    <span className="ml-2 mr-2">Личный кабинет</span>
                    {isSubMenuOpen ? (
                      <ArrowUpIcon
                        type={matchProfile ? "primary" : "secondary"}
                      />
                ...
                <ul
                  className={`${styles.list} ${styles.list__submenu} ${
                ...
                >
                  <li>
                    ...
                    >
                      <span className="ml-8">Профиль</span>
                    </NavLink>
                  </li>
                  <li>
                    <NavLink
                      ...
                      to="/profile/orders"
                    >
                      <span className="ml-8">История заказов</span>
                    </NavLink>
                  </li>
                  <li>
                    <NavLink
                      ...
                      to="/login"
                    >
                      <span className="ml-8">Выход</span>
                    </NavLink>
                  </li>
                </ul>
              </>
